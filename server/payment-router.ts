...
const AGENT_PRICE_ID = process.env.AGENT_PRICE_ID!;
...
/** Subscription for Agent Pro (hard gate w/out webhooks) */
...
/** Agent status: check Stripe live if active/trialing */
